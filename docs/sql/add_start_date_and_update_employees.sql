...
UPDATE employees SET department = 'Kho',                position = 'Nhân viên kho',                        start_date = '2025-08-19' WHERE full_name = 'Lê Duy Tú';
UPDATE employees SET department = 'Kinh doanh',         position = 'Nhân viên Kinh doanh',                 start_date = '2025-10-27' WHERE full_name = 'Nguyễn Quang Minh';
UPDATE employees SET department = 'Marketing',          position = 'Nhân viên Booking',                    start_date = '2025-12-15' WHERE full_name = 'Nguyễn Thị Kim Ngân';
...
UPDATE employees SET department = 'Marketing',          position = 'Nhân viên content',                    start_date = '2026-01-12' WHERE full_name = 'Trương Cẩm Bình';
UPDATE employees SET department = 'Công nghệ',          position = 'Trợ lý vận hành',                     start_date = '2026-03-02' WHERE full_name = 'Ngô Văn Phát';
...
UPDATE employees SET department = 'Marketing',          position = 'Nhân viên content',                    start_date = '2026-03-11' WHERE full_name = 'Đỗ Minh Lương';
UPDATE employees SET department = 'Công nghệ',          position = 'Trợ lý vận hành',                     start_date = '2026-04-06' WHERE full_name = 'Vũ Thị Quỳnh Trang';
UPDATE employees SET department = 'Marketing',          position = 'Nhân viên ADS',                        start_date = '2026-04-13' WHERE full_name = 'Trần Phương Nam';
UPDATE employees SET department = 'Kinh doanh',         position = 'Nhân viên chăm sóc khách hàng',        start_date = '2026-04-22' WHERE full_name = 'Đoàn Anh Phương';
UPDATE employees SET department = 'Marketing',          position = 'Trưởng phòng Marketing',               start_date = '2026-05-04' WHERE full_name = 'Ngô Anh Duy';
UPDATE employees SET department = 'Tài chính-Kế toán',  position = 'Nhân viên kế toán',                   start_date = '2026-05-11' WHERE full_name = 'Nguyễn Thị Nguyệt';
UPDATE employees SET department = 'Tổng hợp',           position = 'Nhân viên mua hàng',                  start_date = '2026-06-01' WHERE full_name = 'Lê Nguyễn Trà My';
UPDATE employees SET department = 'Kho',                position = 'Quản lý kho',                          start_date = '2026-06-08' WHERE full_name = 'Cao Hữu Trí';
UPDATE employees SET department = 'Marketing',          position = 'Leader Booking',                       start_date = '2026-06-09' WHERE full_name = 'Nguyễn Thị Dung';
UPDATE employees SET department = 'Marketing',          position = 'Nhân viên content',                    start_date = '2026-06-15' WHERE full_name = 'Phùng Lê Minh Tuấn';
UPDATE employees SET department = 'Kho',                position = 'Nhân viên kho',                        start_date = '2026-06-16' WHERE full_name = 'Nguyễn Thanh Tùng';
UPDATE employees SET department = 'Kho',                position = 'Nhân viên kho',                        start_date = '2026-06-17' WHERE full_name = 'Lê Minh Đức';
UPDATE employees SET department = 'Kinh doanh',         position = 'Nhân viên chăm sóc khách hàng',        start_date = '2026-06-29' WHERE full_name = 'Hà Thị Thanh Tâm';
